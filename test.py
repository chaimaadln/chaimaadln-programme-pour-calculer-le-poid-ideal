...
def calculer_poids():
    ...
    if taille != 0.0 and sexe != "" and age != 0 and poids_initial != 0.0:
        ...
        if difference_poids > 0:
            ...
            st.markdown('<span style="color: green;">Pour atteindre votre poids idéal, vous pouvez suivre ces recommandations :</span>', unsafe_allow_html=True)
            ...
            st.markdown('<span style="color: red;">*Votre poids est inferieur a votre poids ideal*</span>', unsafe_allow_html=True)
            st.markdown('<span style="color: green;">Pour maintenir un poids sain, vous pouvez suivre ces recommandations :</span>', unsafe_allow_html=True)
